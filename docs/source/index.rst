...
The library offers a wide range of efficiently implemented transforms for annotated volumetric images, an easy-to-use API,
and a neat Getting Started guide. On top of that, it can be used to manipulate your image data in any context
